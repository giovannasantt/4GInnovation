...
/// Tela de perfil do Jovem Ansioso.
/// Apresenta informações investigativas sobre este personagem do bar:
/// comportamento nervoso, possível testemunha assustada, informações fragmentadas.
/// Design de dossiê com foto polaroid, seções organizadas e anotações de alerta.
class JovemAnsiosoFileScreen extends StatelessWidget {
  const JovemAnsiosoFileScreen({Key? key}) : super(key: key);
                ...
                child: Padding(
                  ...
                  child: Container(
                    ...
                    child: Column(
                      children: [
                        NpcFileHeader(
                          fileNumber: '#SC-NPC-008 – JOVEM ANSIOSO',
                          date: '15/11/2025',
                          stickyNoteText: 'Testemunha nervosa',
                        ),
                        ...
                        _buildPolaroidPhoto(
                          'Jovem Ansioso — Testemunha nervosa com informações fragmentadas.',
                        ),
                        const SizedBox(height: 24),
                        ...
                        NpcFileSection(
                          ...
                          child: Column(
                            ...
                            children: [
                              ...
                              const SizedBox(height: 9),
                              _buildInfoField('FUNÇÃO', 'Testemunha nervosa'),
                            ],
                          ),
                        ),
                        const SizedBox(height: 24),
                        ...
                        const NpcFileSection(
                          title: 'DESCRIÇÃO',
                          child: Text(
                            'Parece saber algo, mas o nervosismo constante o faz se contradizer. Tenta ajudar, porém teme as consequências.',
                          ),
                        ),
                        const SizedBox(height: 24),
                        ...
                        const NpcFileSection(
                          ...
                          child: Text(
                            'Moletom com capuz, mochila, óculos redondos. Mexe no celular o tempo todo. Fala acelerado e com hesitação. Mãos inquietas.',
                          ),
                        ),
                        const SizedBox(height: 24),
                        ...
                        NpcFileSection(
                          ...
                          child: Column(
                            children: [
                              _buildQuote('"Eu... eu vi algo, mas não tenho certeza..."'),
                              const SizedBox(height: 9),
                              _buildQuote('"Se eu falar, eles vão saber que fui eu!"'),
                            ],
                          ),
                        ),
                        const SizedBox(height: 24),
                        ...
                        const NpcFileSection(
                          ...
                          child: Text(
                            'Baixo - pistas incompletas mas potencialmente importantes',
                          ),
                        ),
